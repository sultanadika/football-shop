...
SECRET_KEY = 'django-insecure-($wnxxs3e_ohsv-(!tvv#ne!=&39gs8%@lf)=4@y5(pn!m)u7-'

PRODUCTION = os.getenv('PRODUCTION', 'False').lower() == 'true'
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost","127.0.0.1","https://sultanadika-shidqi-footballshop.pbp.cs.ui.ac.id/"]
